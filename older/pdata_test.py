...
df = pd.read_csv('C:\Python_Data_Project\TEMP.ade', sep = ';', header = 1 , squeeze = True)
#df = pd.read_csv('C:\Python_Data_Project\TEMP.ade', sep = ';',header=[1,2], na_values=[-1,''], squeeze = True )
    

df.to_excel("C:\Python_Data_Project\Test.xlsx", index=None, header=True)
